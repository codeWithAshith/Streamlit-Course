...
st.caption('click on the button below to display an image')
button = st.button('Display Image')
if button:
...
with st.container():
    ...
    age = st.number_input('What is your name', min_value=0,
                          max_value=150, value=25, step=1)
